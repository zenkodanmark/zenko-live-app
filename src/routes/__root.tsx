...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", sizes: "192x192", href: asset("/icon-192.png") + "?v=z2" },
      { rel: "icon", type: "image/png", sizes: "512x512", href: asset("/icons/icon-512.png") + "?v=z2" },
      { rel: "apple-touch-icon", href: "/__grok/icon-180.png" },
      { rel: "apple-touch-icon", sizes: "180x180", href: asset("/apple-touch-icon.png") + "?v=z2" },
      { rel: "apple-touch-icon", sizes: "180x180", href: asset("/icons/apple-touch-icon.png") + "?v=z2" },
